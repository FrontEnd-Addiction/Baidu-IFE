class Calendar {
  constructor (
    ...
    this.selectedDate = moment(this.options.initDate || new Date())

    this.options.autoShow && this.render()
  }
  ...
  render () {
    ...
    root && root.appendChild(this.calendar)
  ...
  selectDate ({
    ...
    this.render()
    this.options.callback(this.selectedDate)
